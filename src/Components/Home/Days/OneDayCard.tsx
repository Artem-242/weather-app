...
export const OneDayCard = ({item}: Props) => {
    ...
    return(
        <div className="bg-blue-500 bg-opacity-20 rounded-[10px] min-w-[150px] text-slate-400 p-[10px]">
	        <h5 className="text-black text-lg font-medium mb-[7px]">{day}</h5>
	        <div className=" text-sm mb-[12px]">{date}</div>
	        <div>
		        <SvgSelector id={icon}/>
	        </div>
	        <div className="mt-[13px] text-black text-lg font-medium">{temperature_day}</div>
